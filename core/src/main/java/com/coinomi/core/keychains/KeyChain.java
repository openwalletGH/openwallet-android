package com.coinomi.core.keychains;
/**
 ...
 * that you to use a method of a specific key chain instance, such as {@link com.google.bitcoin.wallet.BasicKeyChain}.
 * The reason for these restrictions is to support key chains that may be handled by external hardware or software,
 * or which are derived deterministically from a seed (and thus the notion of importing a key is meaningless).</p>
 */
